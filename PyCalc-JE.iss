...
AppId={{16BD7EF6-F141-44DD-829B-758449B2F3EB}
AppName={#MyAppName}
...
[Files]
Source: "C:\Users\Master\Chill-Astro\PyCalc-JE\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Master\Chill-Astro\PyCalc-JE\PyCalc-JE.ico"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\PyCalc-JE.ico"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\PyCalc-JE.ico"; Tasks: desktopicon
